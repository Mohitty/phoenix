...
Then('the error message {string} should be displayed in the webUI folder dialog prompt', function (folder) {
  return client
    .page.phoenixPage()
    .waitForElementVisible('@ocDialogPromptAlert')
    .expect.element('@ocDialogPromptAlert').text.to.equal(folder)
})
